...
1) move the â€œKalmanâ€ folder into the â€œlibrariesâ€ subdirectory inside your Arduino sketchbook directory (you can view your sketchbook location by selecting Fileâ†’Preferences in the Arduino environment; if there is not already a â€œlibrariesâ€ folder in that location, you should create it yourself). Then import it with:

  #include <Kalman.h>;
  
2) move the â€œKalmanâ€ folder to the sketchbook you want to use it and then import it with:
